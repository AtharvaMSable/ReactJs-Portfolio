...
const infoData = [
  ...
  },
  {
    ...
    text: "atharvasable021@gmail.com",
  },
  {
    icon: <Calendar size={20} />,
    text: "Born on 16 July, 2004",
  },
  {
...
const qualificationData = [
  {
    ...
    data: [
      ...
      {
        university: "Nutan Vidya Mandir, Deolali Camp, Nashik",
  ...
  },
  {
    ...
    data: [
      {
        comapany: "Amazon",
        role: "Amazon ML Training School",
    ...
    <section className="xl:h-[860px] pb-12 xl:py-24">
      <div className="container-mx-auto">
        ...
        <di className="flex flex-col xl:flex-row">
          {/* image */}
          <div className="hidden xl:flex flex-1 relative container mx-auto">
            <DevImg
                ...
                <TabsContent value="personal">
                  <div className="text-center xl:text-left">
                    ...
                    <div className="flex flex-col gap-y-2">
                      ...
                      <div> English, German, Hindi, Marathi</div>
                    </div>
                  </div>
                </TabsContent>
                {/* qualifications */}
                      ...
                      <div className="flex flex-col gap-y-6">
                        ...
                        <div className="flex flex-col gap-y-8">
                          {getData(qualificationData, "experience").data.map(
                            (item, index) => {
                              const { comapany, role, years } = item;
                              return (
